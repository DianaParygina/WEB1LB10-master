...
<template>
  <div><br>
    ...
    <div v-for="o in owner" class="owner-item">
      ...
      <div v-show="o.pictureOwner" @click="showModal = true; selectedImage = o.pictureOwner"><img :src="o.pictureOwner" style="max-height: 60px;" data-bs-toggle="modal" data-bs-target="#pictureOwnerModal"></div>
    ...
    <form @submit.prevent.stop="onDogClickForOwner">
      <div class="row">
        ...
        <input
              type="text3"
              class="form-control"
              v-model="ownerToAdd.phone_number"
              required
            />
